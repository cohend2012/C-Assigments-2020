...
void localGob()
{
    ...
    cout<<a<<endl; //local but more global
...
void cityLargePop()
{
   int maxindex=0;
   const int SIZE=5;
   int population[SIZE]={100,444,999,3,4};
   string cityName[SIZE]={"Phx","Tempe","Scotts"};
    ...
    cout<<population[maxindex]<<" POP "<<cityName[maxindex];
...
void stringAdder()
{
    ...
    cout<<str1<<" HAS "<<lowerCount<<" lower letters"<<endl;
...
void passwordCreater()
{
    ...
    for(int i=0;i<inputString.length();i++)
    {
        ...
        if(isupper(inputString[i]))//this works becuase when you pull off each char from the string
            //is upper is for chars  need cctype
        {
